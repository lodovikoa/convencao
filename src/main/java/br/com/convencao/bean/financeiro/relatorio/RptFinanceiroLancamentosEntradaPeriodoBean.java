...
@Named(value = "rptFinanceiroLancamentosEntradaPeriodoBean")
@ViewScoped
public class RptFinanceiroLancamentosEntradaPeriodoBean extends Codebehind {
	...
	public void imprimir() {
		...
		StringBuilder jsFunction = new StringBuilder()
				.append("relatorioFinanceiroEntradaPeriodo(")
				.append("'../../relatorioFinanceiroEntradaPeriodo'")
				.append(",'")
				...
				.append(",'")
				.append(getRelatorioFiltro().getPlanoConta() != null? getRelatorioFiltro().getPlanoConta().getDsConta(): "")
				.append("',")
